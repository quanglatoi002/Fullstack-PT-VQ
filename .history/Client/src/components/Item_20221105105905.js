    ...
    return (
        <div className="w-full flex border-t-[2px] border-orange-600 p-4 ">
            <div className="w-2/5 flex flex-wrap gap-[2px] items-center relative">
                ...
                <span className="absolute bottom-0 left-[5px] bg-[rgba(0,0,0,.5)] text-white p-1 rounded">4 image</span>
            </div>
            <div className="w-3/5">
                ...
                <div className="flex items-center my-5 justify-between">
                    ...
                    <div className="flex items-center gap-1.5">
                        <button type="button" className="bg-blue-700 text-white rounded-md lg:p-1 ">
                            Gọi 0986726726
                        </button>
                        <button
                            type="button"
                            className="lg:p-1  border border-blue-700 text-blue-700 text-white rounded-md"
                        >
                            Nhắn Zalo
                        </button>
                    </div>
