    ...
    return (
        <div className="w-full flex border-t-[2px] border-orange-600 p-4 ">
            <div className="w-2/5 flex flex-wrap gap-[2px] items-center relative cursor-pointer">
                ...
                <span className="absolute bottom-2 left-[5px] bg-bg-overlay-50 text-white p-1 rounded">4 image</span>
                <span>
                    <span className="absolute bottom-2 first-letter:right-[5px] text-white px-1 rounded">
                        <RiHeartLine />
                    </span>
                </span>
            </div>
