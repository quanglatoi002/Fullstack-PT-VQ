        ...
        <div className="w-full flex border-t-[2px] border-orange-600 py-4 ">
            ...
            <div className="w-3/5">
                ...
                <div className="my-2 flex items-center justify-between">
                    <span className="font-bold flex-1 text-green-600">{attributes?.price}</span>
                    <span className="flex-3">{attributes?.acreage}</span>
                    <span className="flex-3">{`${address.split(',')[address.split(',').length - 2]}${
