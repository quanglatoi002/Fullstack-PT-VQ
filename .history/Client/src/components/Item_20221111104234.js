        ...
        <div className="w-full flex border-t-[2px] border-orange-600 py-4 ">
            ...
            <div className="w-3/5">
                ...
                <div className="my-2 flex items-center justify-between">
                    <span className="font-bold flex-3 text-green-600 whitespace-nowrap">{attributes?.price}</span>
                    <span className="flex-1">{attributes?.acreage}</span>
                    <span className="flex-3 whitespace-nowrap">{`${address.split(',')[address.split(',').length - 2]}${
